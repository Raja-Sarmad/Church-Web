...
type MissionVisionClientProps = {
  locale: string;
  data?: MissionVisionData | null;
};

const MissionVisionClient = ({ locale, data }: MissionVisionClientProps) => {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-white">
      <div className="flex flex-col lg:flex-row min-h-[650px]">
        ...
        <div className="relative w-full lg:w-[32%] bg-green-900 flex flex-col items-center justify-center p-12 lg:p-16 text-center text-white z-10 overflow-hidden">
...
export default MissionVisionClient;
